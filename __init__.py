...
core_config = _load_module("vae_core_config", os.path.join(plugin_dir, "core", "config.py"))
vae_video_reader = _load_module("vae_video_reader", os.path.join(plugin_dir, "core", "video_reader.py"))

# Load pipeline modules
vae_detector = _load_module("vae_detector", os.path.join(plugin_dir, "pipeline", "detector.py"))
vae_tracker = _load_module("vae_tracker", os.path.join(plugin_dir, "pipeline", "tracker.py"))
...
# Register nodes from the actor extractor module
if hasattr(vae_actor_extractor, "NODE_CLASS_MAPPINGS"):
    NODE_CLASS_MAPPINGS.update(vae_actor_extractor.NODE_CLASS_MAPPINGS)
if hasattr(vae_actor_extractor, "NODE_DISPLAY_NAME_MAPPINGS"):
    NODE_DISPLAY_NAME_MAPPINGS.update(vae_actor_extractor.NODE_DISPLAY_NAME_MAPPINGS)
